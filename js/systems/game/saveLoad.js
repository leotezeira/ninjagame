// ============================================================
// core/saveLoad.js — Guardado, carga y migración de partida
// ============================================================

export const saveLoadMethods = {
    ...
    async loadGame() {
        try {
            ...
            if (!save) { await this.gameAlert('No hay partida guardada', '❌'); return; }
            ...
            if (this.player?.sleepState) this.showSleepOverlay?.();
        } catch (e) {
    ...
    migratePlayerSave() {
        ...
        const defaults = {
            ...
            friendship:              {},
            reputation: {
                konoha: 50, bosque: 0, olas: 0, suna: 0,
                kiri: 0, iwa: 0, kumo: 0, ame: 0, valle: 0, nieve: 0,
            },
            urgentMission:           null,
            npcRelations:            {},
            npcRivals:               {},
        ...
        this.player.lastExamNoticeAbsDay  = Number.isFinite(this.player.lastExamNoticeAbsDay)
            ? this.player.lastExamNoticeAbsDay : -1;
        ...
        if (typeof this.player.examCooldowns !== 'object' || !this.player.examCooldowns) {
            this.player.examCooldowns = { chunin: 0, jonin: 0 };
        }
        ...
        // Flags booleanos
        ['hasDailyIzanagi','dailyIzanagiReady','izanagiAvailable','izanagiUsed','pendingStealKg'].forEach(k => {
            this.player[k] = !!this.player[k];
        });
        ...
        // timeOfDay se calcula en tiempo real, no desde save
